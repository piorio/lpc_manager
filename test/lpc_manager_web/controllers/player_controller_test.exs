defmodule LpcManagerWeb.PlayerControllerTest do
  ...
  @create_attrs %{agility: 42, armour_value: 42, current_value: 42, hiring_fee: 42, injury: 42, missing_next_game: true, movement_allowance: 42, name: "some name", number: 42, passing: 42, strength: 42, temp_retiring: true, total_spp: 42, unspent_spp: 42}
